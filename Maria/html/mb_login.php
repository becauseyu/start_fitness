                        ...
                        <form id='register_form' class="m-5 hidden" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <input id="re_name" name="re_name" type="text" class="form-control ml-5 mr-5"
                                    placeholder="真實姓名" aria-label="Realname" aria-describedby="basic-addon1" required>
                            </div>
                            <div class="input-group mb-3">
                            ...
                            <p align="center">已有會員?請點此<input type="button" class="btn btn-success" id="change_login"
                                    value="登入"></input>
                            </p>
                        </form>
                    </div>
