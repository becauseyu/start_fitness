        ...
        <div class="center-box mt-3 mb-3">
          <div class="row">
            ...
            @foreach ($foodList as $food)
                ...
                <p class='price-font'>NT$<span id='single_price'>{{$food->pprice}}</span><i class='mx-2 fa-solid fa fa-shopping-cart cart2' ></i></p>
                </div>
                </div>
        ...
        <div class="center-box mt-3 mb-3">
          <div class="row">
            ...
            @foreach ($gymList as $gym)
                ...
                <p class='price-font'>NT$<span id='single_price'>{{$gym->pprice}}</span><i class='mx-2 fa-solid fa fa-shopping-cart cart2'></i></p>
                </div>
                </div>
