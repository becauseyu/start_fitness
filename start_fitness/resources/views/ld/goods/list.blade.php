    ...
    <div class="accordion " id="accordionExample">
        ...
        @foreach ($goodsList as $goods)
            ...
            <div class="card ">
                        ...
                        <button class="btn01 btn-block headButton" type="button" data-toggle="collapse"
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 text-center button_bag">
                                    <div class="mr-1 btn01 btn-outline01" onclick="edit('a{{ $goods->pid }}')">編輯</div> |
                ...
                <form id="a{{ $flavor->pid }}" action="/flavor/edit" enctype="multipart/form-data" method="POST">
                    @csrf
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach ($goods->flavor as $flavor)
                                    <tr>
                                        ...
                                        <th>
                                            <div class="mr-1 btn01 btn-outline01" onclick="edit('a{{ $goods->pid }}')">編輯
                                            </div> |
                                            <div class="ml-1 btn01 btn-outline02">刪除</div>
                                        </th>
                                    </tr>
