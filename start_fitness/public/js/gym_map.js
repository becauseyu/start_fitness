...
var url1 = window.location.origin + '/sport/gymmap/list';
var url2 = window.location.origin + '/sport/gymmap/default';
var dataList =getGymData(url1) 
var centerList =getGymData(url2);

console.log(centerList.name)
// (async function(){
//      dataList   =await ;
//      console.log('hi');
//      centerList =await 
