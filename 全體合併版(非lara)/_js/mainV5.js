...
var downloadImage = new Promise((resolve, reject) => {
    junkFood_fries.image.src = '../img/gameImg/bsd_01.png';
    junkFood_burger.image.src = '../img/gameImg/bsd_02.png';
    junkFood_pizza.image.src = '../img/gameImg/bsd_03.png';
    healthFood_salmon.image.src = '../img/gameImg/good_01.png';
    healthFood_cabbage.image.src = '../img/gameImg/good_02.png';
    healthFood_apple.image.src = '../img/gameImg/good_03.png';
    
    playerData.image.w50.src = '../img/gameImg/girl_50.png';
    playerData.image.w60.src = '../img/gameImg/girl_60.png';
    playerData.image.w70.src = '../img/gameImg/girl_70.png';
    playerData.image.w80.src = '../img/gameImg/girl_80.png';
    playerData.image.w100.src = '../img/gameImg/girl_100.png';
})
