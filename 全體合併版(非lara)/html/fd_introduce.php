            ...
            <div class="row ">
                ...
                <div class="card-deck">
                    <div class="col-md-6 card mb-4 border-warning shadow-sm " data-aos="fade-up">
                        <img src="../img/fd_introduce/f1.jpg" alt="" class="img-fluid rounded ">
                    ...
                    <div class="col-md-6 card mb-4 border-warning shadow-sm " data-aos="fade-up">
                        <img src="../img/fd_introduce/f7.png" alt="" class="img-fluid rounded ">
                ...
                <div class="card-deck">
                    <div class="card mb-4 border-warning shadow-sm col-md-4" data-aos="fade-up">
                        ...
                        <img src="../img/fd_introduce/f3.png" class="img-fluid rounded " alt="">
                ...
                <div class="card-deck">
                    ...
                    <div class="card mb-4 border-warning shadow-sm col-md-4" data-aos="fade-up">
                        ...
                        <img src="../img/fd_introduce/f4.png" class="img-fluid rounded " alt="">
