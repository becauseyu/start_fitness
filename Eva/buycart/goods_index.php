        ...
        <div class="center-box mt-3 mb-3">
          <div class="row">
            ...
            while ($good = $resultFood->fetch_object()) {
              ...
              echo   "<img src='../asset/saleitem/food/{$good->ppic}' class='good_img food photoshadow imgee img-fluid mx-auto rounded'>";
              echo   "</a>";
              echo   "</div>";
              echo   "<div class=' '>";
        ...
        <div class="center-box mt-3 mb-3">
          <div class="row">
            ...
            while ($good = $resultGym->fetch_object()) {
              ...
              echo   "<div class='m-2 image-sale'>";
              echo   "<a  href='/Eva/buycart/goods_data.php?pid={$good->pid}'>";
              echo   "<img src='../asset/saleitem/gym/{$good->ppic}' class='good_img food photoshadow imgee img-fluid mx-auto rounded'>";
              echo   "</a>";
              echo   "</div>";
              echo   "<div class=' '>";
              echo   "<div class='cen-brand head-font01'>";
